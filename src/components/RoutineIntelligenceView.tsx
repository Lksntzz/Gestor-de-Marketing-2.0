...
export const RoutineIntelligenceView: React.FC<RoutineIntelligenceViewProps> = ({
  ...
  return (
    <div className="w-full h-full min-h-0 flex flex-col gap-4 font-sans">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-4 flex-1 min-h-0 overflow-y-auto no-scrollbar">
        <div className="xl:col-span-7 flex flex-col gap-4 min-h-0">
          ...
          <section className="bg-surface-card border border-outline-border rounded-xl p-5 flex-1 min-h-0 overflow-hidden flex flex-col">
